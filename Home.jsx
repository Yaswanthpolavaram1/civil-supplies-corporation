...
function Home() {
 ...
 <div className='left-hero md:flex md:flex-col md:w-[60vw] px-
[20px] py-[20px]'>
 ...
 <div className='flex md:flex-row flex-col gap-[10px] justify-evenly 
items-center'>
 <div>
 <img
 ...
 <footer className='flex justify-center items-center py-2 mt-4 border-
[1px] border-black'>
 <p>
