...
function Register() {
 ...
 className='flex flex-col gap-[1rem] border-[1px] bg-white 
rounded-lg blur-0 border-black md:px-[4rem] px-[2rem] py-[2rem]'>
 ...
 <button
 type='submit'
 className='border-[1px] h-[40px] font-bold border-black 
md:py-[5px] hover:bg-[#000] hover:text-white'>
 REGISTER
 </button>
 </form>
 </section>
